...
class AudioInspector {
    fun inspect(context: Context, uri: Uri): AudioMetadata {
    ...
    fun inspectExtractor(extractor: MediaExtractor): AudioMetadata {
    ...
    fun inspectFormatProvider(provider: TrackFormatProvider): AudioMetadata {
